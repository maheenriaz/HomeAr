...
class Home extends React.Component {
  render() {
    categories=[
      ...
      {id:2,image:'https://www.canadianwood.in/wp-content/uploads/2018/03/Application-Furniture.png',name:'Stylish Chair',price:'721$'},
    ...
    return (
      <View style={{backgroundColor:'white',flex:1,justifyContent:'flex-start'}}>
        ...
        <ScrollView>
        <View>
          <Image source={require('../../assets/homegif.gif')} style={{width:'100%',height:200}}/>
        </View>
        <View>

          <Text style={{alignSelf:'center',fontSize:textScale(20),marginTop:moderateScaleVertical(10),fontWeight:'bold',color:'#037276'}}>Top Categories</Text>
        </View>
